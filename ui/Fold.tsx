...
/**
 * Блок экрана, который сворачивается тапом по заголовку (Р-55 «Дневников», Р-61 «Дневников»).
 *
 * Рядом с заголовком всегда стоит итог — число записей или сумма, — и
 * у свёрнутого тоже: «Гигиена · 5», «Требует внимания · 2». Свёрнутое
 * не должно пропадать молча, тот же принцип, что у фильтров (Р-46 «Дневников»).
 *
...
export function Fold({
  ...
  // Пришли к записи, которая лежит в свёрнутом блоке (Р-56 «Дневников»): блок
  ...
  // Свёрнутый — строка оглавления: плотно, с линией до соседа (Р-73 «Дневников»).
