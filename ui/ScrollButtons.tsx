...
/** Сколько кнопки видны после прокрутки. Дальше прячутся, чтобы не закрывать текст (Р-73 «Дневников»). */
const AWAKE_MS = 2500

/**
 * Кнопки «в начало» и «в конец» (Р-55 «Дневников»).
 *
 ...
 *
 * Видны, пока экран листают, и ещё пару секунд после (Р-73 «Дневников»): висящие
