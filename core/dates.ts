 ...
 *
 * Заведён под контент (Р-25 «Дневников»): в дневнике просмотренного дней нет вовсе.
...
/**
 * Дата известной точности: полный день либо месяц. Р-25 «Дневников».
 *
 ...
 * синхронизации (Р-34 «Дневников»), она не должна ронять весь экран. Одна строка
...
/**
 * Дата известной точности на экран (Р-25 «Дневников»): день показывается днём,
 * месяц — месяцем.
 *
...
// ─── Недели и промежутки ───────────────────────────────────────────────────
// Своё «Делу Время»: обзор недели (Р-41 «Делу Время») и итоги за промежуток (Р-52 «Делу Время»).

/**
 * Промежуток дней, оба конца включительно. Итоги обзора считаются по нему,
 * а не по «неделе»: на тех же расчётах встанут месяц и год (Р-52 «Делу Время»).
 */
export type Period = { from: DateStr; to: DateStr }

/** Понедельник недели, в которую входит день: неделя — с понедельника (Р-41 «Делу Время»). */
 ...
 * (Р-25 «Дневников»), когда сомнение толкуется в пользу позднего дня.
 */
...
// ─── Месяцы и годы ─────────────────────────────────────────────────────────
// Своё «Делу Время»: итоги месяца и года (Р-54 «Делу Время», Р-57 «Делу Время»).
 ...
 * месяцу своего воскресенья (Р-55 «Делу Время»): каждая попадает ровно в один месяц, и к
 ...
 * закрывает (Р-54 «Делу Время»). Null — ни один месяц в нём не кончается.
 */
 ...
 * кода, а не вписывается руками (Р-65 «Дневников»). Одна минута — без числа: «через
