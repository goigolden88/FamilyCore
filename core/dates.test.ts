...
describe('formatMonth и formatDateOrMonth', () => {
  it('месяц показывается месяцем, а не первым числом — Р-25 «Дневников»', () => {
...
describe('недели и промежутки — Р-41 «Делу Время», Р-52 «Делу Время»', () => {
...
describe('месяцы и годы — Р-54 «Делу Время», Р-55 «Делу Время», Р-57 «Делу Время»', () => {
