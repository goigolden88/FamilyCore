/**
 * Напоминания: о незаполненном дне (Р-14 «Делу Время», Р-24 «Делу Время») и об обзоре недели (Р-51 «Делу Время»).
 *
...
/**
 * Имя фоновой проверки (Р-24 «Делу Время»). Общее на все напоминания приложения:
...
/** То же для напоминания об обзоре недели (Р-51 «Делу Время»): свои дни, прежние ключи смысла не меняют. */
...
async function decide(
  ...
  // Экран в тексте — своим именем этого устройства (Р-26 «Делу Время»).
 ...
 * громкое о дне не глушит напоминание об обзоре (Р-51 «Делу Время»). Окно — общее.
 */
